        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubMembers_ClubMembers_TrainerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingSessions_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryWeapon = table.Column<int>(type: "int", nullable: true),
                    Category = table.Column<int>(type: "int", nullable: true),
                    ISSFLicenseNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ISSFLicenseExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NationalLicenseNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    NationalLicenseExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MedicalCertificateNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    MedicalCertificateExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AdditionalNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShooterProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShooterProfiles_ClubMembers_ClubMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShooterProfiles_ClubMemberId",
                table: "ShooterProfiles",
                column: "ClubMemberId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingSessions_CreatedById",
                table: "TrainingSessions",
                column: "CreatedById");
        }
